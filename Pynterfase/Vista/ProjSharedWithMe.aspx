        ...
        <div class="navbar nav-collapse"> 
            <asp:Repeater ID="RpProyectos" runat="server">
                <ItemTemplate>
                        ...
                        <div class="col-12 col-sm-12 col-md-3 col-lg-2 mx-2 nav-item my-2 cajaProj" style="background-image:url('imagenes/SharedBox.svg'); background-size:cover; border-radius : 10px; height:300px; ">
