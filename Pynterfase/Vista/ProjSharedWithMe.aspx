        ...
        <div class="navbar nav-collapse cajasanim"> 
            <asp:Repeater ID="RpProyectos" runat="server">
                <ItemTemplate>
                        ...
                        <div class="col-12 col-sm-12 col-md-5 col-lg-4 mx-2 nav-item my-2 cajaProj" style="background-image:url('imagenes/SharedBox.svg'); background-size:cover; border-radius : 10px; height:300px; ">
                            ...
                            <div class="container-fluid" style="position:relative;">
                                <asp:Button ID="btnOpenProj" runat="server" Text="ENTRAR" CssClass=" w-100 botones" OnClick="btnOpenProj_Click"/>                                
                            </div>
